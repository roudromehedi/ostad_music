...
<template>
  ...
  <Form :validation-schema="schema" @submit="userStore.register" :initial-values="userData">
    <!-- Name -->
    <div class="mb-3">
    ...
    <!-- TOS -->
    <div class="mb-3 pl-6">
      <Field type="checkbox" class="w-4 h-4 float-left -ml-6 mt-1 rounded" name="tos" value="1" />
